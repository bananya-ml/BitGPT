...
def ParseArgs():
    ...
    parser.add_argument('--verbose',type=int,default=0,metavar='S',
                        help='set to 1 to see all recommended tunable parameters, 2 to see all parameters(default: False)')
...
with open(os.path.join(os.getcwd(),'data/astro.txt'), 'r', encoding='utf-8') as f:
    text = f.read()
